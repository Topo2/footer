...
<form method="POST" enctype="multipart/form-data">
	...
	<table class="Total_Soft_AMTable">
		...
		<tr>
			<td>Video Title <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="This section is mandatory. Each video must given a name."></i></td>
		...
		<tr>
			<td>Link <i class="Total_Soft_Help1 totalsoft totalsoft-question-circle-o" title="You must complete this window if you want your videos has links."></i></td>
